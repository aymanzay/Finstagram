...
class AuthProvider {
    ...
    func signup(withEmail: String, withUsername: String, password: String, profileImg: Data?, loginHandler: LoginHandler?) {
        ...
        Auth.auth().createUser(withEmail: withEmail, password: password, completion: { (user, error) in
            ...
            if error != nil { //error creating user
                ...
                if userID != nil {
                    ...
                    //If image is available save profile with image
                    if profileImg != nil {
                        StorageProvider.Instance.saveProfileImage(withID: userID!, username: withUsername, email: withEmail, img: profileImg!)
                    }else{
                        DBProvider.Instance.saveUser(withID: userID!, username: withUsername, email: withEmail, profileImgURL: "None")
                    }
